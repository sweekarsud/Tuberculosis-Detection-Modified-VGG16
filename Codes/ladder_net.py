...
def get_ladder_network_fc(layer_sizes=[128*128, 1000, 500, 250, 250, 250, 2], 
     noise_std=0.3,
    ...
    tr_m.compile(keras.optimizers.Adam(lr=0.0002 ), 'categorical_crossentropy', metrics=['accuracy'])

    tr_m.metrics.append("den_loss")
