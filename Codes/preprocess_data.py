# -*- coding: utf-8 -*-
"""
Created on Tue Mar 17 22:40:15 2020
...
def preprocess(inDir, outDir, size=224):
    ...
    if num == 0:
        print("Please put the images into the data folder.")
        sys.exit(1)
    ...
    for i, f in enumerate(files):
        ...
        imageio.imwrite(out_path, img_resized)

current_path = os.getcwd()

os.mkdir(current_path + '/proc_data')

data_dir1 = current_path + '/data/ChinaSet_AllFiles/'
proc_dir1 = current_path + '/proc_data/ChinaSet_AllFiles/'

preprocess(data_dir1, proc_dir1, 224)

data_dir2 = current_path + '/data/MontgomerySet/'
proc_dir2 = current_path + '/proc_data/MontgomerySet/'

preprocess(data_dir2, proc_dir2, 224)
